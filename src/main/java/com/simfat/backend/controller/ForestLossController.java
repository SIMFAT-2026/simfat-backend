...
public class ForestLossController {
    ...
    public ResponseEntity<Void> getByYear(@PathVariable Integer year) {
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).build();
    }

    @PostMapping
    public ResponseEntity<Void> create(@Valid @RequestBody ForestLossRecord record) {
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).build();
    }

    @PutMapping("/{id}")
    public ResponseEntity<Void> update(@PathVariable String id, @Valid @RequestBody ForestLossRecord record) {
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).build();
    }
